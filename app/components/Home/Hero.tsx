...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
            <h1  className="font-anton mt-80 uppercase text-center text-[40px] md:text-[60px] lg:text-[80px] xl:text-[95px] big:text-[110px]">
              {title}
            </h1>
            ...
            <a className="grid grid-cols-[max-content_max-content] gap-2 mx-auto items-center cursor-pointer">
